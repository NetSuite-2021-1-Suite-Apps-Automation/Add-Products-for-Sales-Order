...
public class ITestListenerImpl extends ExtentReportListener implements ITestListener {
	...
	private void emailToSingleReceipient(String receipient) throws EmailException {
		...
		attachment.setPath("./Extent_report/AddProductsSOTestReport.html");
		...
		email.setSubject("Add Products Test Report for Sales Order");
		email.setMsg("Hey, Automation testing for Add Products SuiteApp for Sales Order is completed. Please find the test report attached below");
